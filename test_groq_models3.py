...
try:
    print("Testing llama3-8b-8192 with truncated text...")
    llm = ChatGroq(model="llama3-8b-8192", groq_api_key="gsk_fake_key_for_testing_purposes", temperature=0)
    ...
    print("FAILED llama3-8b-8192:", str(e))
